...
The API integrates a public dataset from Kaggle (https://www.kaggle.com/datasets/tabibyte/aoty-5000-highest-user-rated-albums) and allows retrieving, filtering, and analysing album data. The API is demonstrable via a local execution using Uvicorn, and can be accessed through FastAPI’s Swagger UI (See _Start Server_).
